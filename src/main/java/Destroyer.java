 ...
 */
public class Destroyer extends Rectangle {

    private final static int S_W = 61;
    ...
    public Rectangle create(MouseEvent event) {
        Rectangle mold = new Rectangle(startingXPlacement = event.getSceneX() - 20,
                startingYPlacement = event.getSceneY() - 180, S_W, S_H);
        mold.setFill(Color.rgb(255, 100, 50, 0.5));
        return mold;
    }
